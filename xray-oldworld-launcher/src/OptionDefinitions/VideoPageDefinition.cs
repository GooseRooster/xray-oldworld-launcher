    ...
    private static OptionGroup AdvancedMainGroup() => new()
    {
        ...
        Options = new()
        {
            ...
            new() { Id = "dof_enable", ConsoleCommand = "r2_dof_enable", Type = OptionType.Check, ValueType = OptionValueType.Bool,
                DefaultValue = "true", VisibleWhen = IsDynamicLighting },
            new() { Id = "dof_autofocus", ConsoleCommand = "r2_dof_autofocus", Type = OptionType.Check, ValueType = OptionValueType.Bool,
                DefaultValue = "false", BoolToNum = true, VisibleWhen = IsDynamicLighting },
            new() { Id = "dof_aim", ConsoleCommand = "r2_dof_aim", Type = OptionType.Check, ValueType = OptionValueType.Bool,
                DefaultValue = "true", BoolToNum = true, VisibleWhen = IsDynamicLighting },
            new() { Id = "dof_reload", ConsoleCommand = "r2_dof_reload", Type = OptionType.Check, ValueType = OptionValueType.Bool,
                DefaultValue = "true", BoolToNum = true, VisibleWhen = IsDynamicLighting },
            new() { Id = "dof_ui", ConsoleCommand = "r2_dof_ui", Type = OptionType.Check, ValueType = OptionValueType.Bool,
                DefaultValue = "false", BoolToNum = true, VisibleWhen = IsDynamicLighting },
            new() { Id = "dof_dialog", ConsoleCommand = "r2_dof_dialog", Type = OptionType.Check, ValueType = OptionValueType.Bool,
                DefaultValue = "false", BoolToNum = true, VisibleWhen = IsDynamicLighting },
            new() { Id = "dof_focus_speed", ConsoleCommand = "r2_dof_focus_speed", Type = OptionType.Track, ValueType = OptionValueType.Float,
                DefaultValue = "20.0", Min = 1, Max = 20, Step = 0.5, VisibleWhen = IsDynamicLighting },
            new() { Id = "dof_focus_sharpness", ConsoleCommand = "r2_dof_coc_power", Type = OptionType.Track, ValueType = OptionValueType.Float,
                DefaultValue = "3.0", Min = 0.5, Max = 5, Step = 0.5, VisibleWhen = IsDynamicLighting },
            new() { Id = "dof_max_blur", ConsoleCommand = "r2_dof_max_blur", Type = OptionType.Track, ValueType = OptionValueType.Float,
                DefaultValue = "0.7", Min = 0.1, Max = 1.0, Step = 0.05, VisibleWhen = IsDynamicLighting },
            new() { Id = "dof_peripheral_blur", ConsoleCommand = "r2_dof_peripheral_softness", Type = OptionType.Track, ValueType = OptionValueType.Float,
                DefaultValue = "0.0", Min = 0, Max = 0.5, Step = 0.05, VisibleWhen = IsDynamicLighting },
